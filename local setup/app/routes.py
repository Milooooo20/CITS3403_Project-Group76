from flask import app, render_template, request, redirect, flash, url_for, jsonify
...
@blueprint.route('/delete_song/<int:song_id>', methods=['DELETE'])
@login_required
...
@blueprint.route('/get_shared_users')
@login_required
